...
bg9 = pygame.image.load("fairybg.png")
...
def talk_to_cat ():
    ...
    message_to_screen("mysterious world filled with strange fantasy creatures. It looks like my worst ", white, -180, size = "okie")
...
def talk_to_rock ():
    ...
    message_to_screen("Type A to use a hammer to break the big rocks", blue, 20, size = "okie1")
    message_to_screen("Type S to play the flute", blue, 40, size = "okie1")
    message_to_screen("Type D to read the book from the unicorn", blue, 60, size = "okie1")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_a:
                    ...
                    message_to_screen("I tell a story about a beautiful garden, a story my mom used to", white, -120, size = "okie")
                    message_to_screen("as a child. The rocks thank me for bringing them joy and life", white, -100, size = "okie")
                    message_to_screen("in their boring life. I walk away contently and I pass by a cave,", white, -80, size = "okie")
                    message_to_screen("I see a piece of paper wedged between the rocks of the cave. I", white, -60, size = "okie")
                    message_to_screen("wiggle out the piece of paper and read it. 'There is no love without'", white, -40, size = "okie")
                    message_to_screen("forgiveness and there is no forgiveness without love.' I don\'t understand", white, -20, size = "okie")
                    message_to_screen("and keep walking straight.", white, 0, size = "okie")
...
def talk_to_mom ():
    ...
    message_to_screen("'Why did you leave me all alone in the house?' Fear creeps into my chest", white, -160, size = "okie")
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_a:
                    ...
                    message_to_screen("other than to myself and forgiving others will lessen my shoulders. ", white, 0, size = "okie")
...
def gameThanks():
    ...
    message_to_screen("Press SPACE to return to the title screen", red, 220, size = "small")
